Pod::Spec.new do |s|
  ...
  s.source_files        = 'Src/Lib/BuddySDK/*.{h,m}', 'Src/Lib/BuddySDK/{BaseObjects,BPObjects,BPCollections,Categories,Service}/*.{h,m}', 'Src/Lib/BuddySDK/Vendor/{JAGPropertyConverter,ObjectiveSugar}/**/*.{h,m}'
